...
if __name__ == "__main__":
    list_models = []
    list_models.append(ModelPrint("CNN", "inception_rs_normal_do07_result_range_top100_by_species.npy", "g", "-"))
    ...
    #list_models.append(ModelPrint("RF", "rf_rs_env_d17_result_range_top100_by_species.npy", "r", "-"))
