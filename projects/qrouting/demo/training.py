...
from contrib.games.Biggest import Biggest
from contrib.models.fc import Net


def run(xp_name, params, epoch=0, export=False, email=0, file=False):
    # Ce que je veux

    setup_and_run_experiment(xp_name, Biggest, params, Net, MSELoss(), epoch=epoch, export=export,
