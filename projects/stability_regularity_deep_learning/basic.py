...
from datascience.ml.neural.supervised.callbacks.callbacks import ParameterVarianceCallback
...
validation_params = {
    ...
    'vcallback': (ParameterVarianceCallback(averaged=False),)  # (NewStatCallback(train),)
}
