...
input_size = model.module.input_size if type(model) is torch.nn.DataParallel else model.input_size
...
fit(
    model, train=train, test=test, training_params=training_params, optim_params=optim_params, cross_validation=True
)
