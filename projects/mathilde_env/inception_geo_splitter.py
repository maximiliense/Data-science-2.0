...
from datascience.data.model_selection.geosplitter import DatasetSplitterGeoQuadra
...
# loading dataset
train, val, test = occurrence_loader(EnvironmentalDataset, source='glc18', splitter=DatasetSplitterGeoQuadra(10))
